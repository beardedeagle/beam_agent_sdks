%%%-------------------------------------------------------------------
%%% @doc Bounded message queue wrapping OTP's `queue' module.
%%%
...
%% @doc Push an item onto the back of the queue.
%%      Returns `{error, queue_full}' if at capacity.
...
%% @doc Pop an item from the front of the queue.
%%      Returns `empty' if the queue has no items.
