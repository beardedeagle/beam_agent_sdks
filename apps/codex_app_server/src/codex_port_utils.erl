%%%-------------------------------------------------------------------
%%% @doc Shared utility functions for Codex port-based adapters.
%%%
...
%% @doc Append a complete line (with trailing newline) to the buffer.
%%      Returns the updated buffer, truncated to empty if overflow.
...
%% @doc Append a partial (incomplete line) to the buffer.
%%      Returns the updated buffer, truncated to empty if overflow.
