...
-moduledoc """
Convenience API facade for the OpenCode HTTP agent SDK.
...
-doc """
List all active sessions on the OpenCode server.
...
-doc """
Get details for a specific session by ID from the OpenCode server.
This is the native OpenCode REST endpoint.
...
-doc """
Delete a session by ID on the OpenCode server.
This is the native OpenCode REST endpoint.
