...
-moduledoc """
Convenience API for the Claude Code agent SDK.
...
-doc """
Send a query with parameters, collect all messages (blocking).
...
-doc """
List session transcripts from the Claude config directory.
...
-doc """
List native session transcripts with optional filters.
...
-doc """
Get all messages from a native session transcript by ID.
...
-doc """
Get all messages from a native session transcript with options.
Options: `config_dir`.
""".
